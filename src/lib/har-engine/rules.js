...
export const HAZARD_RULES_SCHEMA = {
    ...
    "earthquake_rules": {
        ...
        "liquefaction": {
            ...
            "gmma_ready_conditions": {
                "low_potential":      { "template": "Low Potential" },
                "moderate_potential": { "template": "Moderate Potential" },
                "high_potential":     { "template": "High Potential" },
                "note": "Never use 'partly' or 'largely' modifiers for GMMA-READY maps regardless of partial zone coverage. Low Potential is treated as safe for mitigation text selection."
            }
        },
        "earthquake_induced_landslide": {
            ...
            "gep_thresholds": {
                "note": "Used when regional EIL map data is unavailable. Compute a General Elevation Profile (GEP) and apply these thresholds.",
                "slope_safe_max_deg": 15,
                "slope_safe_max_pct": 25,
                "slope_susceptible_min_deg": 15,
                "depositional_safe_condition": "H > 3 × ΔE where ΔE = Elev_Max − Elev_Min",
                "depositional_prone_status": "Prone; Within the depositional zone"
            }
        },
        "tsunami": {
            ...
            "conditions": {
                ...
                "no_data_low_lying_coastal": { "template": "Low-lying coastal area is prone to local tsunami due to offshore fault or submarine landslide" }
            }
        }
    },
    "volcano_rules": {
        ...
        "distance_rules": {
            "outside_safe_zone": {
                "condition": "distance_km > 50 OR outside_watershed",
            ...
            "outside_safe_zone_island": {
                "condition": "distance_km > 50 OR outside_watershed, AND is_island_volcano",
                "explanation": "Considering the distance of the site from the volcano, the site is safe from erupted products of a hazardous volcanic eruption.",
                "recommendation": ""
            }
        },
        "pdz_danger_zone": {
            ...
            "conditions": {
                ...
                "no_pdz_within_10km": "The site is within the delineated 10-kilometer radius of the volcano and is considered as highly prone to eruptive processes and products in the event of an eruption."
            },
            "special_cases": {
        ...
        "volcanic_tsunami": {
            ...
            "recommendation": "Tsunami threat related to the volcanic unrests can be addressed by community preparedness and tsunami evacuation plan, with special focus on shoreline communities. Be aware of the three natural signs of tsunami: 1) strong ground shaking; 2) unusual rise or fall of lake/sea level; and 3) strong or unusual sound coming from the lake/sea. Evacuate immediately to higher ground upon observing any of these signs.",
            "policy": { "show_explanation_if_safe": false },
            "conditions": {
                "safe": "Safe",
                "prone": "Prone"
